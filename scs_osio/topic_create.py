...
./scs_osio/topic_create.py /orgs/south-coast-science-dev/test/1/status -n "test" -d "test of status" -s 28 -v
"""
...
from scs_osio.cmd.cmd_topic_create import CmdTopicCreate
